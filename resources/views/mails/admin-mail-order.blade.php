          ...
          <td>
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <div class="menu-links">
                                          ...
                                          [endif]-->[endif]--><!--[if mso]><td style="padding-top:10px;padding-right:15px;padding-bottom:10px;padding-left:15px"><!
                                          [endif]--><a
                              ...
                              <tr>
                                <td class="pad">
                                  <h2
                                    ...
                                    "
                                  >
                                    Good day, this is an order notification from {{auth()->user()->names}}!. Confirm and get ready to ship!. 
                                  </h2>
                                </td>
                              </tr>
                            </table>
                                ...
                                >
                                  <tr>
                                    ...
                                    >
                                      ...
                                      >
                                        <p style="margin: 0">
                                          <strong>{{ $item->product->title }}</strong><br />{{ $item->product->category->name }}<br /><br /><strong
                                            >  ${{$item->product->amount}}  X {{$item->quantity}}</strong
                                          >
                                            @if (!is_null($options))
            ...
            @php
                ...
                foreach ($product as $order) {
                    ...
                    $unitPrice = isset($order->unit_price) ? $order->unit_price : ($order->product->amount ?? 0);
                    
                    // Assuming $order->quantity and $unitPrice are numeric values
                              ...
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <p style="margin: 0">
                                        {{$shipping->names}}<br />{{$shipping->address}}<br />{{$shipping->phone}}<br />{{$shipping->cityName}}<br />{{$shipping->countryName}}
                                    </p>
                                  </div>
                                </td>
                              </tr>
                            ...
                            >
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    <p style="margin: 0">
                                      <a href="{{url('vendor/customer_orders')}}" style="text-align: center;">Login to view orders</strong>
                                    </p>
                                  </div>
                                </td>
                              </tr>
                                  ...
                                  <div align="center" class="alignment">
                                    ...
                                    >
                                      <tr>
                                        <td style="padding: 0 2px 0 2px">
                                          <a
                                            ...
                                            ><img
                                              alt="facebook"
                                              height="32"
                                              src="https://zebraline.ai/media/imgs/facebook2x.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                        ...
                                        <td style="padding: 0 2px 0 2px">
                                          ...
                                          href="{{$socialHandles->twitter}}"
                                            ...
                                            ><img
                                              alt="twitter"
                                              height="32"
                                              src="https://zebraline.ai/media/imgs/twitter2x.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                        ...
                                        <td style="padding: 0 2px 0 2px">
                                          <a
                                            href="{{$socialHandles->tiktok}}"
                                            target="_blank"
                                            ><img
                                              alt="tiktok"
                                              height="32"
                                              src="https://zebraline.ai/media/imgs/tiktok@2x.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                        ...
                                        <td style="padding: 0 2px 0 2px">
                                          <a
                                            ...
                                            ><img
                                              alt="youtube"
                                              height="32"
                                              src="https://zebraline.ai/media/imgs/youtube@2x.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                        ...
                                        <td style="padding: 0 2px 0 2px">
                                          <a
                                            ...
                                            ><img
                                              alt="instagram"
                                              height="32"
                                              src="https://zebraline.ai/media/imgs/instagram@2x.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                            ...
                            >
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    <p style="margin: 0; margin-bottom: 16px">
                                      If you have questions regarding your data,
                                      please visit our
                                      <a
                                        href="#"
                                        rel="noopener"
                                        ...
                                        target="_blank"
                                        >Privacy Policy.</a
                                      ><br /><br />Want to change how you
                                      receive these emails? <br />You can
                                      <a
                                        href="#"
                                        rel="noopener"
                                        style="
                                    ...
                                    <p style="margin: 0">
                                      <br />© 2023 Company. All Rights Reserved.
                                    </p>
                                  </div>
                                </td>
                              </tr>
